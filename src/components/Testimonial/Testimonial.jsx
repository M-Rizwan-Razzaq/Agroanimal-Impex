...
const testimonialData = [
  {
    description:"Synth chartreuse iPhone lomo cray raw denim brunch everyday carry neutra before they sold out fixie 90's microdosing. Tacos pinterest fanny pack venmo, post-ironic heirloom try-hard pabst authentic iceland.",
    ...
    <Slider {...settings}>
{
  testimonialData.map((elm)=>(
    <div className="p-4 md:w-1/2 w-full bg-transparent">
        <div className="h-full text-white p-8 rounded card-test">
          ...
          <a className="inline-flex items-center">
            <img alt="testimonial" src={elm.imgurl} className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center"/>
            <span className="flex-grow flex flex-col pl-4">
              <span className="title-font font-medium">{elm.name}</span>
              <span className="text-orange-300 text-sm">{elm.profasion}</span>
            </span>
          </a>
        </div>
      </div>
