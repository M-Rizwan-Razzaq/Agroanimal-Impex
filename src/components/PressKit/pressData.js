const pressKitData = [
  {
    id: 1,
  title: "Active Taxpayer Verification",
  date: "April 30, 2025",
  author: "FBR Pakistan",
  description:
    "AGROANIMAL IMPEX (SMC-PRIVATE) LIMITED is listed as an active taxpayer. Registration No: E621026. Verified status confirms timely tax filing.",
  ...
  date: "April 15, 2025",
  author: "Meezan Bank Khanewal",
  description:
    "Meezan Bank certifies that M/S AGROANIMAL IMPEX (SMC-PRIVATE) maintains a PKR Rupee Current Account (PK16MEZN0077010111464942) since January 27, 2025. Issued on customer request without bank liability.",
  ...
  date: "June 20, 2015",
  author: "Bahauddin Zakariya University, Multan",
  description:
    "Certified that Muhammad Tayyab Iqbal S/o Muhammad Iqbal completed the Doctor of Veterinary Medicine program for the session 2009-2014 with a grade of B. Authorized to practice Veterinary and Animal Sciences.",
    image: "./Certificate/(3).jpg"
  },
  {
    id: 4,
  title: "Registered Veterinary Medical Practitioner (RVMP)",
  date: "July 12, 2023",
  author: "Pakistan Veterinary Medical Council",
  description:
    "Dr. Muhammad Tayyab Iqbal was officially registered as a Veterinary Medical Practitioner under PVMC. Registered with code 10499 and valid until July 11, 2028. Holds a DVM degree from Bahauddin Zakariya University, Multan (2015).",
    image: "./Certificate/(4).jpg"
  },
  {
    id: 5,
  title: "Solid Waste Management Training",
  date: "January 12, 2018",
  author: "AHK National Centre for Rural Development, Islamabad",
  description:
    "Dr. M. Tayyab Iqbal participated in a five-day training course on Solid Waste Management, held from January 8-12, 2018 at AHK NCRD, Park Road, Chak Shahzad, Islamabad, Pakistan.",
  ...
  author: "Securities and Exchange Commission of Pakistan (SECP), Company Registration Office Multan",
  description:
