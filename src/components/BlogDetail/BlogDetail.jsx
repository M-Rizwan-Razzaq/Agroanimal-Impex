...
const BlogDetail = () => {
  ...
  return (
    <div>
      ...
      <div className="md:px-8 py-8 flex gap-[6rem]">
        {/* blog detail left box */}
        <div className="w-[60%]">
          <h1 className="text-4xl ">Complete Solution For Your Land Design</h1>
          ...
          <img
            ...
            alt=""
            className="rounded-lg mt-6 h-[70vh]  w-full"
          />
          ...
          <div className="flex py-10 px-10 bg-gray-200 mt-10 text-2xl">
            <p>
            ...
            <svg
              ...
              fill="currentColor"
              className="block w-20 h-20 text-green-900 mb-4"
          ...
          <h2 className="text-2xl  mt-7">Setting the mood with incense</h2>
          ...
          <div className="flex justify-between mt-10 next-pre-box py-10">
          ...
          <h2 className="text-3xl font-semibold">3 Comments</h2>

          <div>
            {[...new Array(3)].map(() => (
              <div className="bg-white px-12  py-9 flex gap-8  shadow-2xl mt-3">
                <img
                ...
                <div>
                  <div className="flex justify-between items-center">
                    <div>
                      <h2 className="text-lg font-semibold">Felix Design</h2>
                      <p className="text-[#CCB100]">September 12, 2023</p>
                    </div>
                    <button className="bg-green-900 hover:bg-[#CCB100] px-[12px] py-2 rounded-md text-white ">
                      {" "}
          ...
          <h2 className="mt-16 mb-2 text-4xl ">Leave a Reply</h2>
          <p>
          ...
          <div className="rounded bg-white px-8 py-10 box-border">
            {[...new Array(6)].map(() => (
              ...
              <div className="w-[25%] rounded-lg overflow-hidden">
                <img src="https://demo2.themelexus.com/farmor/wp-content/uploads/2023/09/blog-12.jpg" alt="" className=" w-full h-full object-cover" />
                </div>
               <div>
